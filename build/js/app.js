...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(16)(module), __webpack_require__(17)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__TweenMax_js__ = __webpack_require__(18);
...
var _wow = __webpack_require__(14);
...
(0, _jquery2.default)(document).ready(function () {
    (0, _jquery2.default)('.scroll_menu').click(function () {
        var scroll_el = (0, _jquery2.default)(this).attr('href');
        if ((0, _jquery2.default)(scroll_el).length != 0) {
            (0, _jquery2.default)('html, body').animate({ scrollTop: (0, _jquery2.default)(scroll_el).offset().top }, 500);
        }
        return false;
    });
    (0, _jquery2.default)('.button-scroll').click(function () {
        var scroll_el = (0, _jquery2.default)(this).attr('href');
        if ((0, _jquery2.default)(scroll_el).length != 0) {
            (0, _jquery2.default)('html, body').animate({ scrollTop: (0, _jquery2.default)(scroll_el).offset().top }, 500);
        }
...
(function () {
    ...
    var menu = new Menu((0, _utils._)('.desktop_menu_content'));

    (0, _utils._)('.header_action_buton').addEventListener('click', function (e) {
        (0, _utils._)('.desktop_menu').style.display = 'flex';
        menu.open();
    });

    (0, _utils._)('.close_header_button').addEventListener('click', function (e) {
        menu.close();
        (0, _utils._)('.desktop_menu').style.display = 'none';
    });

    window.addEventListener('scroll', function (e) {
        if (!(0, _utils._)('header').classList.contains('fixed_header')) {

            (0, _utils._)('header').classList.toggle('fixed_header');
            var tl = new _gsap.TimelineMax();
            tl.fromTo((0, _utils._)('header'), 0.3, { y: '-100px', autoAlpha: 0 }, { y: '0', autoAlpha: 1 });
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TweenMaxBase_js__ = __webpack_require__(19);
...
(function () {
    var letters = (0, _utils.__)('.preloader span');
    _gsap.TweenMax.staggerFrom(letters, 0.25, { opacity: 0, x: Math.floor(Math.random() * 100), ease: Back.easeOut }, 0.1);

    setTimeout(function () {
        _gsap.TweenMax.to((0, _utils._)('.preloader'), 0.3, { autoAlpha: 0 });
    }, 1000);
})();
...
(0, _jquery2.default)(".comments_slider").slick((_$$slick = {
    infinite: false,
    nextArrow: (0, _jquery2.default)('.next'),
    prevArrow: (0, _jquery2.default)('.prev')
}, _defineProperty(_$$slick, "infinite", true), _defineProperty(_$$slick, "dots", false), _defineProperty(_$$slick, "speed", 300), _defineProperty(_$$slick, "responsive", [{
...
(0, _jquery2.default)(".comments_slider").on("init", function (event, slick) {
    (0, _jquery2.default)(".comments_title_content_number").text(parseInt(slick.currentSlide + 1) + ".");
});

(0, _jquery2.default)(".comments_slider").on("afterChange", function (event, slick, currentSlide) {
    (0, _jquery2.default)(".comments_title_content_number").text(parseInt(slick.currentSlide + 1) + ".");
});
...
(function () {
    var upButton = (0, _utils._)('.action_button');
    var tl = new _gsap.TimelineMax();
